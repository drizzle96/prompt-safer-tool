...
exports.normalizeCustomRule = normalizeCustomRule;
exports.classifyUrlType = classifyUrlType;
exports.internalUrlRuleFrom = internalUrlRuleFrom;
...
function normalizeCustomRule(rule, order) {
...
function classifyUrlType(value) {
    try {
...
function internalUrlRuleFrom(rule) {
    return {
        ...rule,
        id: "internal_url",
        ruleId: undefined,
